...
static void dummy(void* pcParameters);
const portTickType xDelay = 1 / portTICK_RATE_MS;
const portTickType taskPeriod = 5/portTICK_RATE_MS;
...
int main()
{
	...
	// Tasks
	xTaskCreate( taskA, (signed char * ) "TaskA", configMINIMAL_STACK_SIZE, NULL, tskIDLE_PRIORITY + 2, NULL);
	xTaskCreate( taskB, (signed char * ) "TaskB", configMINIMAL_STACK_SIZE, NULL, tskIDLE_PRIORITY + 2, NULL);
	xTaskCreate( taskC, (signed char * ) "TaskC", configMINIMAL_STACK_SIZE, NULL, tskIDLE_PRIORITY + 3, NULL);
	xTaskCreate( dummy, (signed char * ) "dummy", configMINIMAL_STACK_SIZE, NULL, tskIDLE_PRIORITY + 1, NULL);
