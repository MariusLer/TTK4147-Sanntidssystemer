...
int main()
{
	...
	xTaskCreate( taskB, (signed char * ) "TaskB", configMINIMAL_STACK_SIZE, NULL, tskIDLE_PRIORITY + 3, NULL);
	xTaskCreate( taskC, (signed char * ) "TaskC", configMINIMAL_STACK_SIZE, NULL, tskIDLE_PRIORITY + 5, NULL);
